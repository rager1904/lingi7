...
class DisputeService:
    ...
    def raise_dispute(
        *,
        ...
        if escrow_account.state != EscrowAccount.State.DELIVERED:
            raise EscrowError(
        ...
        EscrowService.transition_to_disputed(
            escrow_account=escrow_account,
            actor=raised_by,
            trigger="buyer_dispute_raised",
        )
        ...
        AdminAuditLog.objects.create(
            ...
            before_state="",
            after_state=Dispute.Status.OPEN,
        )
    ...
    def resolve_buyer_favour(
        *,
        ...
        # Transition escrow → REFUNDED
        EscrowService.transition_to_refunded(
            escrow_account=escrow_account,
            actor=resolved_by,
            refund_amount=actual_refund,
            trigger="dispute_resolved_buyer_favour",
        )
    ...
    def resolve_vendor_favour(
        *,
        ...
        EscrowService.release_to_vendor(
            escrow_account=escrow_account,
