...
SERVER_EMAIL = config("DEFAULT_FROM_EMAIL", default="noreply@lingi7.co.zm")
...
MTN_MOMO_CALLBACK_HOST = config("MTN_MOMO_CALLBACK_HOST", default="")
...
# Escrow auto-confirm timeout (days after delivery before funds auto-release)
