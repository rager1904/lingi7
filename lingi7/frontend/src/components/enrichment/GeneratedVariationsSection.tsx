    ...
    <section aria-label="Generated visuals">
      <Stack gap="6">
        ...
        <div className="generated-visuals-grid">
                    ...
                    <Stack gap="2">
                      ...
                      <Stack gap="1">
                        {qualityIssues[index]!.map((issue, issueIdx) => (
                          <div key={issueIdx} style={{ display: "flex", alignItems: "flex-start", gap: "6px" }}>
                            <span
                              style={{
                                color: "#f97316",
                                fontSize: "14px",
          ...
          <Card>
            <Stack gap="4">
              <ModelViewer3D modelUrl={generated3DModel} error={model3DError} isGenerating={isGenerating} />
              <Button
                kind="secondary"
                size="medium"
        ...
        <Modal
          ...
          slotHeading={
            selectedImageIndex !== null ? `Generated Variation ${selectedImageIndex + 1}` : "Generated Image"
          }
          slotFooter={
            <Flex align="center" justify="end" gap="3">
              <Button kind="tertiary" size="medium" onClick={() => setModalOpen(false)}>
                Close
              </Button>
