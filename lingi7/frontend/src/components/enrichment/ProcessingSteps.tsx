...
const STEP_DEFINITIONS = [
  { id: "vlm", label: "Vision Analysis", description: "Extracting visual features and attributes" },
  {
    ...
    description: "Enhancing product content with LLM, current data and brand instructions",
  },
];
...
const StatusIcon = ({ status }: { status: StepStatus }) =>
  status === "active" ? (
    ...
    <div
      style={{ width: "40px", height: "40px", borderRadius: "50%", border: "3px solid rgba(128, 128, 128, 0.4)" }}
    />
  );
    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "16px" }}>
      ...
      <div style={{ textAlign: "center" }}>
        <Text
          ...
          className={step.status === "active" ? "open-source-green-text" : "text-primary"}
        >
          {step.label}
        </Text>
